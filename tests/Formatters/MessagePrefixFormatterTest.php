...
class MessagePrefixFormatterTest extends FormatterTestCase {
	public function testPlain() {
		...
		$this->assertEquals('Prefix: This is a test', $testLogger->getLastLine()->getMessage());
	}
	...
	public function testArray() {
		...
		$logger->log(LogLevel::DEBUG, 'This is a test');
		$this->assertEquals('Level0 > Level1 > Level2: This is a test', $testLogger->getLastLine()->getMessage());
	}
}
